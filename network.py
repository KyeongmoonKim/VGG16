...
class Network:
    ...
    def set_fc_var(self, in_size, out_size, name):
    ...
    #  with tf.variable_scope(name):
        weights, biases = self.set_fc_var(in_size, out_size, name)
    ...
    def save_model(self, sess, iter):
        ...
        ckpt_path = temp_saver.save(sess, cf.SAVE_PATH+'save_3200_plus_'+str(iter)+'.ckpt')
